...
public class FinalData{
	...
	public static void main(String[] args){
		...
		fd1.v2.i++; //Объект не является неизменимым!
		...
		//fd1.VAL_3=new Value(1);//ошибка: ссылку нельзя изменить
		//fd1.a =newint[3];
		print(fd1);
		print("Создаем FinalData");
		FinalData fd2 =new FinalData("fd2");
		print(fd1);//i4 можно задать приинициализации, но дальее изменить не получится,
		print(fd2);//INT_5 константа времени компиляции, всегда постоянна
	}
}